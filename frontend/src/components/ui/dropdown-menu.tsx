...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      data-inset={inset}
      className={cn(
        "relative gap-2 [&_svg]:pointer-events-none [&_svg]:w-4 [&_svg]:h-4 [&_svg]:shrink-0 flex cursor-default select-none items-center rounded-base border border-transparent bg-main px-2 py-1.5 text-sm font-base outline-hidden transition-all hover:shadow-shadow hover:border-1 hover:-translate-x-boxShadowX hover:-translate-y-boxShadowY active:translate-x-0 active:translate-y-0 active:shadow-none data-[inset=true]:pl-8 data-disabled:pointer-events-none data-disabled:opacity-50",
        className,
      )}
      {...props}
    />

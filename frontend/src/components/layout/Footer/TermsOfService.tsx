      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Last updated: May 7, 2025</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4 text-sm">
            ...
            <p>
              ...
              our services, you represent and warrant that you meet all
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Engaging in any activity that interferes with or disrupts our
                services
              </li>
            </ul>
            ...
            <p>
              ...
              use, arising out of or in connection with your use of our
              services.
            </p>
            ...
            <p>
              ...
              our services after any changes, you accept and agree to the
              revised Terms.
            </p>
